...
BASE_URL = "https://www.mangooutlet.com/pt/pt/c/homem/descontos-especiais/3b6679e9"
SOURCE_STORE = "Mango Outlet"
import datetime

OUTPUT_FILE = f"mango_man_products_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
