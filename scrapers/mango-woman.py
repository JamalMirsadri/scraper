...
BASE_URL = "https://www.mangooutlet.com/pt/pt/c/mulher/mais-de-70/67980598"
SOURCE_STORE = "Mango Outlet"
import datetime

OUTPUT_FILE = f"mango_woman_products_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
