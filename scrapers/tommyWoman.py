...
BASE_URL = "https://pt.tommy.com/womens-sale"
SOURCE_STORE = "Tommy Hilfiger"
OUTPUT_FILE = "tommy_Woman_products{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
PROGRESS_FILE = "tommy_woman_progress{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
