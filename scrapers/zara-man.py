...
BASE_LIST_URL = "https://www.lojazaraportugal.com/jaquetas-c-8.html"
LIST_PARAMS = "gender=2&sort=20a"
SITE_ROOT = "https://www.lojazaraportugal.com/"
SOURCE_STORE = "Zara"

OUTPUT_FILE = "zara_men_products{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
PROGRESS_FILE = "zara_men_progress{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
