...
BASE_LIST_URL = "https://www.poloclub.com/pt-pt/collections/homem-best-seller"
SITE_ROOT = "https://www.poloclub.com/"
SOURCE_STORE = "Polo Club"

OUTPUT_FILE = "poloclub_men_products.csv"
PROGRESS_FILE = "poloclub_men_progress{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
