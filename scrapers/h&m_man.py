...
BASE_URL = "https://www2.hm.com/pt_pt/homem/last-chance/ver-tudo.html"
SOURCE_STORE = "H&M"
OUTPUT_FILE = "h&m_man_products.csv"
PROGRESS_FILE = "h&m_man_progress{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
